...
@interface IDEComparisonEditor : IDEEditor
{
    ...
    id _primaryDocumentExportToken;
    id _primaryPathControlUpdateToken;
    IDEEditorDocument *_secondaryDocument;
    id _secondaryDocumentExportToken;
    id _secondaryPathControlUpdateToken;
    IDEEditorDocument *_ancestorDocument;
    id _ancestorDocumentExportToken;
...
@property(retain) id comparisonEditorDelegate; // @synthesize comparisonEditorDelegate=_comparisonEditorDelegate;
...
- (void)_convertDocumentLocationToComparisonDocumentLocation:(id)arg1 completionBlock:(dispatch_block_t)arg2;
...
@property(retain) id dataSource; // @synthesize dataSource=_dataSource;
- (void)viewDidInstall;
- (void)loadView;
