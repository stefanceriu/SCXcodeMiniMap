...
@interface IDEEditorContext : IDEViewController
{
    ...
    id _deferredUpdateSubDocumentNavigableItemsCancellableToken;
    ...
    dispatch_block_t _swipeCompletionBlock;
    ...
    dispatch_block_t _retryOpenOperationBlock;
}
...
@property(copy) dispatch_block_t retryOpenOperationBlock; // @synthesize retryOpenOperationBlock=_retryOpenOperationBlock;
...
- (int)_openNavigableItem:(id)arg1 documentExtension:(id)arg2 document:(id)arg3 shouldInstallEditorBlock:(dispatch_block_t)arg4;
- (int)_openNavigableItem:(id)arg1 withContentsOfURL:(id)arg2 documentExtension:(id)arg3 shouldInstallEditorBlock:(dispatch_block_t)arg4;
...
- (int)_openNavigableItem:(id)arg1 withContentsOfURL:(id)arg2 shouldInstallEditorBlock:(dispatch_block_t)arg3;
...
- (void)_performBlockInsideReentrantGuard:(dispatch_block_t)arg1;
